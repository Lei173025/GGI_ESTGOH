...
<body>
  ...
  <div id="page-content-wrapper">
    <div class="container-fluid">
      ...
      <h1><?php print($lang_GerirConta); ?></h1>
      <br>
      <br>
      <form>
        <div class="container ">
          <div class="row">
            ...
            <div class="col-12 center-imagem">
                <img src=<?php $_SESSION['USER_IMAGEM']?> width="70" height="70"  alt="">
            </div>
            <div class="col-12 text-center">
              <button type="submit" class="btn btn-primary"><?php print($lang_AlterarFoto); ?></button>
          ...
          <br><br>
            <div class= "row">
            <div class="col-12 text-center">
              <label for="inputNomeXXXX" class="font-weight-bold"><?php print($_SESSION['USER_NOME']); ?>&nbsp&nbsp&nbsp</label>
              <button type="submit" class="btn btn-primary"><?php print($lang_AlterarNome); ?></button>
              <!-- Inserir Codigo para inserir imagem -->
